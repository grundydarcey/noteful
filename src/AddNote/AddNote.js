      ...
      <div className="AddNote">
        <form className="newNoteForm" onSubmit={(e) => this.handleSubmit(e)}>
          <fieldset>
            ...
            <label htmlFor="noteName" id="noteName">Enter your note name here:</label>
            <br />
            <input
              type="text"
              name="noteName"
            ...
            />
            <br />
            <label htmlFor="noteContent" id="noteContent">Note Text:</label>
            <br />
            <textarea
              id="noteContent"
              name="noteContent"
            ...
            />
            <br />
            <label htmlFor="targetFolder" id="targetFolder">Select a folder</label>
            <br />
            <select
              name="targetFolder"
              id="targetFolder"
